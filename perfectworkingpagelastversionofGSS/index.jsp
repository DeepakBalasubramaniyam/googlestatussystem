		 ...
		 function a(){ 
		 	...
		 	var data1 = {
		 			 ...
		 			 document.getElementById("link").disabled = true;
		 			   document.getElementById("new").className = "btn btn-primary active";
		 ...
		 function b(){ 
		 	...
		 	var data1 = {
		 			...
		 			//newly added
	 	    			 ...
	 	    			 document.getElementById("new").className = "btn btn-primary disabled";
				...
				<tr class="greycolor">
					...
					<th><div id="158">
							<button id="new" onclick="b()" type="button"
								class="btn btn-primary disabled">New</button>
						</div></th>
