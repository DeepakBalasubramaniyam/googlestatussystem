			 	    		 		 			 ...
			 	    		 		 			 a.href = "first.jsp";
			 	    		 	    			   document.getElementById("52").appendChild(a);
			 	    	    	    	    	          ...
			 	    	    	    	    	          //updating dates as old history
			 	    	    	    	    	         	 ...
			 	    	    	    	    	         	 var employees1 = [
	                           {
	                           "11":"CurrentStatus","12":"10/14/15","13":"10/15/15","14":"10/16/15","15":"10/17/15","16":"10/18/15","17":"10/19/15","18":"10/20/15",
	                           }
	                                         ];			
		...
		<table class="table table-bordered" id="table">
			...
			<thead class="greycolor">
				...
				<tr>
					...
					<th><div id="12">10/14/15</div></th>
					<th><div id="13">10/15/15</div></th>
					<th><div id="14">10/16/15</div></th>
					<th><div id="15">10/17/15</div></th>
					<th><div id="16">10/18/15</div></th>
					<th><div id="17">10/19/15</div></th>
					<th><div id="18">10/20/15</div></th>
...
<button id="link" onclick="a()" type="button"
								class="btn btn-primary btn-lg btn-block">Old</button>
<button id="new" onclick="b()" type="button"
								class="btn btn-primary btn-lg btn-block">New</button>
<button id="back" onclick="d()" type="button"
								class="btn btn-primary btn-lg btn-block">Back</button>
