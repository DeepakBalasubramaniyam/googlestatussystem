		 ...
		 function a(){ 
		 	...
		 	var data1 = {
		 	 ...
		 	 data1.images.forEach( function(obj) {
	 			 ...
	 			 //a.href = "first.jsp";
	 			 document.getElementById("23").appendChild(button);
	 			...
	 			button.id="button1";
	 			 ...
	 			 //when pressing the old button we saying to hide old and show new
	 			  $(document).ready(function(){
	 				  //here we are calling a b() function after clicking a button id button1
	 				 $('.btn22').click(c);
 				        $("#link").hide();
 				       $("#back").hide();
 				       $("#new").show();
		 	...
		 	var data2 = {
		 	 ...
		 	 data2.images.forEach( function(obj) {
	 			 ...
	 			 button.appendChild(img);
	 			 //a.href = "first.jsp";
	 			 document.getElementById("37").appendChild(button);
	 			button.className="btn22";
	 			button.id="button2";
				...
				var data3 = {
			 	 ...
			 	 data3.images.forEach( function(obj) {
		 			 ...
		 			 button.appendChild(img);
		 			 //a.href = "first.jsp";
		 			 document.getElementById("53").appendChild(button);
		 			button.className="btn22";
		 			button.id="button3";
			 	...
			 	var data4 = {
			 	 ...
			 	 data4.images.forEach( function(obj) {
		 			 ...
		 			 button.appendChild(img);
		 			 //a.href = "first.jsp";
		 			 document.getElementById("75").appendChild(button);
		 			button.className="btn22";
		 			button.id="button4";
		 			 $(document).ready(function(){
		 				  //here we are calling a b() function after clicking a button id button1
			 	...
			 	var data5 = {
			 	 ...
			 	 data5.images.forEach( function(obj) {
		 			 ...
		 			 button.appendChild(img);
		 			 //a.href = "first.jsp";
		 			 document.getElementById("48").appendChild(button);
		 			button.className="btn22";
		 			button.id="button5";
		 ...
		 function b(){ 
		 	 ...
		 	 */          
				 	 ...
				 	 data1.images.forEach( function(obj) {
			 			 ...
			 			 button.appendChild(img);
			 			 //a.href = "first.jsp";
			 			 document.getElementById("22").appendChild(button);
			 			button.className="btn23";
			 			button.id="button6";
				 	...
				 	var data2 = {
				 	 ...
				 	 data2.images.forEach( function(obj) {
			 			 ...
			 			 button.appendChild(img);
			 			 //a.href = "first.jsp";
			 			 document.getElementById("35").appendChild(button);
			 			button.className="btn23";
			 			button.id="button7";
			 			$(document).ready(function(){
			 				$('.btn23').click(c);
				 	...
				 	var data3 = {
				 	 ...
				 	 data3.images.forEach( function(obj) {
			 			 ...
			 			 button.appendChild(img);
			 			 //a.href = "first.jsp";
			 			 document.getElementById("47").appendChild(button);
			 			button.className="btn23";
			 			button.id="button8";
			 			$(document).ready(function(){
			 				$('.btn23').click(c);
				 	...
				 	var data4 = {
				 	 ...
				 	 data4.images.forEach( function(obj) {
			 			 ...
			 			 button.appendChild(img);
			 			 //a.href = "first.jsp";
			 			 document.getElementById("52").appendChild(button);
			 			button.className="btn23";
			 			button.id="button9";
			 			$(document).ready(function(){
			 				$('.btn23').click(c);
